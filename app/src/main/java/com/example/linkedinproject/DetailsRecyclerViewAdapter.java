...
import com.example.linkedinproject.DetailsFragment.OnListFragmentInteractionListener;
import com.example.linkedinproject.dummy.DummyContent.DummyItem;
...
public class DetailsRecyclerViewAdapter extends RecyclerView.Adapter<DetailsRecyclerViewAdapter.ViewHolder> {
    ...
    private final List<Answer> mValues;
    private final OnListFragmentInteractionListener mListener;

    public DetailsRecyclerViewAdapter(List<Answer> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
